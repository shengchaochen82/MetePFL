...
class Options(object):
    ...
    def __init__(self):
        ...
        # Prompting Learning for Federated Learning
        self.parser.add_argument('--clients', type=int, default=88, help="Numbers of Clients")
        self.parser.add_argument('--client_frac', type=float, default=0.1, help="Fraction all of clients")
        self.parser.add_argument('--nodes', type=int, default=88, help="Sensors' node of original dataset")
        self.parser.add_argument('--com_round', type=int, default=50, help="Model class")
        self.parser.add_argument('--agg', type=str, default='avg', help="agg algorithm")
        self.parser.add_argument('--input_length', type=int, default=12, help='Length of input sequences')
        self.parser.add_argument('--forecasting_length', type=int, default=21, help='Length of forecasting sequence length')
        self.parser.add_argument('--prompting_length', type=int, default=3, help='Length of promoting')
        self.parser.add_argument('--total_len', type=int, default=32, help='Length of the sequence in Pre-trained Transformer')
        self.parser.add_argument('--ynprompt', type=str, default="prompting_learning", help='Length of the sequence in Pre-trained Transformer')
        self.parser.add_argument('--prompt_app', type=str, default="Data_Interaction", choices={"Data_Interaction", "sigl_prompt", "bernousep_prompt", "bernou_prompt", "horzion_prompt"})
        self.parser.add_argument('--local_mode_t', type=str, choices={'Train', "Informer_train", "Fedformer_train", "Autoformer_train", "None", "Train"})   
        self.parser.add_argument('--local_mode_v', type=str, choices={'Test', "Informer_val", "Fedformer_val", "Autoformer_val", "None", "Test"})                  
        self.parser.add_argument('--former_pretrain', type=bool, default=False)   
        self.parser.add_argument('--dataset', type=str, default="Percipition", choices={"Percipition",  "Surface_temp", "Surface_index"})  
    def parse(self):
